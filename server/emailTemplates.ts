...
export async function sendOrderConfirmationEmail(
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>¡Gracias por usar AstroBar! 🚀</p>
          </div>
          <div class="footer">
            <p>AstroBar - Conectando Autlán</p>
  ...
  try {
    await resend.emails.send({
      from: 'AstroBar <pedidos@AstroBar.app>',
      to,
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div style="text-align: center;">
              <a href="https://AstroBar.app/orders/${data.orderNumber}/review" class="cta">
...
export async function sendPaymentReceiptEmail(
  ...
  try {
    await resend.emails.send({
      from: 'AstroBar <pagos@AstroBar.app>',
      to,
