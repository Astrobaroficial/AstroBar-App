...
const JWT_SECRET = process.env.JWT_SECRET || 'AstroBar-secret-key-change-in-production';
const REFRESH_SECRET = process.env.REFRESH_SECRET || 'AstroBar-refresh-secret-change-in-production';
