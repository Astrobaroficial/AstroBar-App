...
-- Los pedidos generan puntos igual que las promociones
...
-- Actualizar user_points para incluir pedidos
ALTER TABLE user_points 
ADD COLUMN orders_completed INT DEFAULT 0 COMMENT 'Total de pedidos completados',
ADD COLUMN points_from_orders INT DEFAULT 0 COMMENT 'Puntos ganados por pedidos';
