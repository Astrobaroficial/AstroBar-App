...
export default function EnhancedWalletScreen() {
    ...
    <ScrollView>
      ...
      >
        <View style={styles.balanceHeader}>
          <Text style={styles.balanceTitle}>AstroBar Wallet</Text>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.investmentOption}>
          ...
          <View style={styles.investmentOptionInfo}>
            <Text style={styles.investmentOptionTitle}>Ahorro AstroBar</Text>
    ...
    <ScrollView>
      ...
      >
        <View style={styles.cardHeader}>
          <Text style={styles.cardTitle}>AstroBar Card</Text>
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>AstroBar Wallet</Text>
