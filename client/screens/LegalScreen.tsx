    ...
    sections: [
      {
        ...
        content:
          "Al utilizar la aplicacion AstroBar, aceptas estos terminos y condiciones. AstroBar es un plataforma de promociones de comida y productos de mercado en Buenos Aires, Argentina.",
      },
      {
        title: "2. Uso del Servicio",
        content:
          "AstroBar proporciona una plataforma para conectar clientes con restaurantes, mercados y repartidores locales. Los usuarios deben tener al menos 18 anos para utilizar el servicio.",
      },
      {
      ...
      },
      {
        ...
        content:
          "AstroBar actua como intermediario entre clientes y negocios. No somos responsables de la calidad de los productos o servicios proporcionados por terceros.",
      },
      {
        title: "6. Propiedad Intelectual",
        content:
          "El nombre AstroBar, logotipos y contenido de la aplicacion son propiedad de AstroBar. Esta prohibida su reproduccion sin autorizacion.",
      },
    ],
  },
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "Puedes solicitar acceso, correccion o eliminacion de tus datos personales contactando a soporte@AstroBar.mx.",
      },
      {
    ...
    <ThemedView style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <View style={styles.headerTitle}>
          <Feather name={content.icon} size={20} color={AstroBarColors.primary} />
      ...
      >
        <View
          style={[
            styles.brandBadge,
            { backgroundColor: AstroBarColors.primary + "15" },
          ]}
        >
          <ThemedText
            type="body"
        ...
        <View style={[styles.contactSection, { backgroundColor: theme.card }]}>
          ...
          <View style={{ marginLeft: Spacing.md }}>
            ...
            <ThemedText type="small" style={{ color: theme.textSecondary }}>
              Contactanos: soporte@AstroBar.mx
            </ThemedText>
          </View>
        </View>
      </ScrollView>
