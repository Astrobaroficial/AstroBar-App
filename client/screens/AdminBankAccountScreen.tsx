      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={[styles.card, { backgroundColor: theme.card }, Shadows.md]}>
          ...
          <Pressable
            ...
            style={[styles.saveButton, { backgroundColor: AstroBarColors.primary, opacity: saveMutation.isPending ? 0.5 : 1 }]}
          >
        ...
        {data?.bankAccount && (
          <View style={[styles.previewCard, { backgroundColor: AstroBarColors.success + "20" }]}>
